...
export default function VMRDetailPage() {
  ...
  return (
    <div className="p-8">
      <div className="mb-6">
        <Link href="/vmrs" className="flex items-center gap-2 text-sm text-gray-500 hover:text-gray-700 mb-4">
          <ArrowLeft size={16} /> Back to VMRs
        </Link>
