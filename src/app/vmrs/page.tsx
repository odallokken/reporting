...
export default function VMRsPage() {
  ...
  return (
    <div className="p-8">
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Virtual Meeting Rooms</h1>
          <p className="text-gray-500 mt-1">{total} VMRs total</p>
        </div>
        <a
            ...
            <tbody className="divide-y divide-gray-100">
              {loading ? (
                ...
                vmrs.map(vmr => (
                  <tr
                    key={vmr.id}
                    onClick={() => router.push(`/vmrs/${vmr.id}`)}
